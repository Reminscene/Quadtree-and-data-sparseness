...
class ReadGPSData:
    def __init__(self, GPS_data):  # 类属性
        self.GPS_data = "C://Users//张晨皓//Desktop//Quadtree//data//hour0.txt"
        print("正在读取GPS数据中...")
...
with open('C://Users//张晨皓//Desktop//Quadtree//data//0-1Vacant trajectory.json', 'w') as f:
    f.write(Line_GDF.to_json())

with open('C://Users//张晨皓//Desktop//Quadtree//data//0-1Carry trajectory.json', 'w') as f:
    f.write(carry_Line_GDF.to_json())


with open('C://Users//张晨皓//Desktop//Quadtree//data//0-1Grids_quadtree.json', 'w') as f:
